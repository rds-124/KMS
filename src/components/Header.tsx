          ...
          <div className="flex items-center gap-4">
            <Link href="/" className="flex items-center">
              <div className="bg-primary-foreground rounded-full px-4 py-1 shadow-inner flex flex-col items-center">
                  <span className="font-bold font-headline text-2xl leading-none bg-gradient-to-b from-primary via-primary to-black bg-clip-text text-transparent">Karavali</span>
